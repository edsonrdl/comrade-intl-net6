...
{
    private readonly ISystemPermissionValidateTag _systemPermissionValidateSameName;

    public SystemPermissionCreateValidation(ISystemPermissionValidateTag systemPermissionValidateSameName)
    {
